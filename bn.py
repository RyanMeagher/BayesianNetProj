...
# Query
print(cancer_infer.query(variables=['Dyspnoea'], joint=False, evidence={'Cancer': 0})['Dyspnoea'])
print(cancer_infer.query(variables=['Cancer'], joint =False, evidence={'Smoker': 0, 'Pollution': 0})['Cancer'])
